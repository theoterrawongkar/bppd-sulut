...
<div class="space-y-5 mt-4">
    ...
    <div class="grid grid-cols-2 gap-3">
        ...
        <div class="space-y-3">
            {{-- Nama Usaha --}}
            <div>
                <label for="business_name" class="block text-sm font-medium text-gray-700">Nama Usaha</label>
            ...
            {{-- Deskripsi Usaha --}}
            <div>
                <label for="description" class="block text-sm font-medium text-gray-700">Deskripsi Usaha</label>
        ...
        <div class="space-y-3">
            ...
            {{-- Email Pemilik --}}
            <div>
                <label for="owner_email" class="block text-sm font-medium text-gray-700">Email Pemilik</label>
    ...
    <div class="space-y-3">
        ...
        <div>
            <label for="sub_category_id" class="block text-sm font-medium text-gray-700">Kategori Kuliner</label>
        ...
        {{-- Jenis Makanan --}}
        <div>
            <label for="types_of_food" class="block text-sm font-medium text-gray-700">Jenis Makanan</label>
        ...
        <div class="space-y-3">
            @foreach ($days as $day)
                ...
                <div x-data="{ closed: {{ $isClosed ? 'true' : 'false' }} }" class="grid grid-cols-4 gap-3 items-center">
                    ...
                    {{-- Jam Buka --}}
                    <div class="">
                        <input type="time" name="open_time[{{ $day }}]" x-bind:disabled="closed"
                    ...
                    {{-- Jam Tutup --}}
                    <div class="">
                        <input type="time" name="close_time[{{ $day }}]" x-bind:disabled="closed"
                            class="w-full px-2 py-1 border border-gray-300 rounded-md text-sm"
