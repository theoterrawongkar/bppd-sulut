    ...
    <section class="py-10 px-4 sm:px-6 lg:px-8">
        <div class="container mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {{-- Galeri --}}
                <div class="" x-data="{
                    mainImage: '{{ $culinaryPlace->firstImage ? asset('storage/' . $culinaryPlace->firstImage->image) : asset('img/placeholder.webp') }}'
                }">
                ...
                <div class="bg-white p-5 rounded-xl shadow-md">
                    ...
                    <div class="space-y-5">
                        ...
                        <form method="POST" action="{{ route('myculinaryplace.update', $culinaryPlace->slug) }}"
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <input id="business_name" type="text" name="business_name"
                                            value="{{ old('business_name', $culinaryPlace->business_name) }}"
                                    ...
                                    <div>
                                        ...
                                        <textarea id="address" name="address" rows="2"
                                            class="w-full mt-1 py-1 px-2 text-sm border border-gray-300 rounded-md shadow-sm focus:outline-[#486284] resize-none">{{ old('address', $culinaryPlace->address) }}</textarea>
                                        @error('address')
                                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input id="gmaps_link" type="text" name="gmaps_link"
                                            value="{{ old('gmaps_link', $culinaryPlace->gmaps_link) }}"
                                    ...
                                    <div>
                                        ...
                                        <textarea id="description" name="description" rows="3"
                                            class="w-full mt-1 py-1 px-2 text-sm border border-gray-300 rounded-md shadow-sm focus:outline-[#486284] resize-none">{{ old('description', $culinaryPlace->description) }}</textarea>
                                        @error('description')
                                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <input id="owner_name" type="text" name="owner_name"
                                            value="{{ old('owner_name', $culinaryPlace->owner_name) }}"
                                            class="w-full mt-1 py-1 px-2 text-sm border border-gray-300 rounded-md shadow-sm focus:outline-[#486284]">
                                        @error('owner_name')
                                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <input id="owner_email" type="email" name="owner_email"
                                            value="{{ old('owner_email', $culinaryPlace->owner_email) }}"
                                            class="w-full mt-1 py-1 px-2 text-sm border border-gray-300 rounded-md shadow-sm focus:outline-[#486284]">
                                        @error('owner_email')
                                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <input id="phone" type="text" name="phone"
                                            value="{{ old('phone', $culinaryPlace->phone) }}"
                                            class="w-full mt-1 py-1 px-2 text-sm border border-gray-300 rounded-md shadow-sm focus:outline-[#486284]">
                                        @error('phone')
                                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <input id="instagram_link" type="text" name="instagram_link"
                                            value="{{ old('instagram_link', $culinaryPlace->instagram_link) }}"
                                            class="w-full mt-1 py-1 px-2 text-sm border border-gray-300 rounded-md shadow-sm focus:outline-[#486284]">
                                    ...
                                    <div>
                                        ...
                                        <input id="facebook_link" type="text" name="facebook_link"
                                            value="{{ old('facebook_link', $culinaryPlace->facebook_link) }}"
                                            class="w-full mt-1 py-1 px-2 text-sm border border-gray-300 rounded-md shadow-sm focus:outline-[#486284]">
                                        @error('facebook_link')
                                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                        @enderror
                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <select id="sub_category_id" name="sub_category_id"
                                        ...
                                        @foreach ($culinarySubCategories as $sub)
                                            <option value="{{ $sub->id }}" @selected(old('sub_category_id', $culinaryPlace->sub_category_id) == $sub->id)>
                                                {{ $sub->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select id="types_of_food" name="types_of_food"
                                        ...
                                        <option value="Halal" @selected(old('types_of_food', $culinaryPlace->types_of_food) == 'Halal')>Halal</option>
                                        <option value="Non Halal" @selected(old('types_of_food', $culinaryPlace->types_of_food) == 'Non Halal')>Non Halal</option>
                                    </select>
                                    @error('types_of_food')
                                        <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                    @enderror
                            ...
                            {{-- Upload Menu --}}
                            <div class="space-y-3">
                                {{-- Upload Menu (PDF/Gambar) --}}
                                <div>
                                    <label for="menu_path" class="block text-sm font-medium text-gray-700">Upload
                                        Menu
                                        (PDF/Gambar)</label>
                                    ...
                                    @if ($culinaryPlace->menu_path)
                                        <p class="text-xs text-gray-600 mt-1">Saat ini: <a
                                                href="{{ asset('storage/' . $culinaryPlace->menu_path) }}"
                                                target="_blank" class="underline text-blue-500">Lihat File</a></p>
                                    @endif
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-1 mt-1 text-sm">
                                    @php
                                        ...
                                        $selectedFacilities = old('facility', $culinaryPlace->facility ?? []);
                                    @endphp
                            ...
                            @if ($culinaryPlace->status == 'Tutup Permanen')
