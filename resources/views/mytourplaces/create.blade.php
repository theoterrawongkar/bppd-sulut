            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white p-5 rounded-xl shadow-md">
                    ...
                    <div class="space-y-5">
                        ...
                        <form method="POST" action="{{ route('mytourplace.store') }}" enctype="multipart/form-data"
                            class="space-y-5">
                            @csrf
                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <input id="ticket_price" type="number" step="0.01" name="ticket_price"
                                        ...
                                        class="w-full mt-1 py-1 px-2 text-sm border border-gray-300 rounded-md shadow-sm focus:outline-[#486284]">
                                    <p class="mt-1 text-xs text-gray-500">Kosongkan jika tidak dipungut biaya/gratis
                                    </p>
                                    @error('ticket_price')
                                        <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                    @enderror
